...
class EL1008 : public soem_interface::EthercatSlaveBase {
public:
  EL1008(const std::string& name, soem_interface::EthercatBusBase* bus, const uint32_t address);
  ~EL1008() override = default;
