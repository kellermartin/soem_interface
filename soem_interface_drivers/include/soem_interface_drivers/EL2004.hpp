...
class EL2004 : public soem_interface::EthercatSlaveBase {
public:
  EL2004(const std::string& name, soem_interface::EthercatBusBase* bus, const uint32_t address);
  ~EL2004() override = default;
...
private:
  ...
  PdoInfo pdoInfo_;
  EL2004_TxPdo reading_;
  EL2004_RxPdo command_;
  std::bitset<4> outputs_;
