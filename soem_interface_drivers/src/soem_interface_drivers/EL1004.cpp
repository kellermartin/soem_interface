...
EL1004::EL1004(const std::string& name, soem_interface::EthercatBusBase* bus, const uint32_t address) :
...
void EL1004::updateWrite() {
  //bus_->writeRxPdo(address_, command_);
}

void EL1004::shutdown() {
  // Do nothing
}
